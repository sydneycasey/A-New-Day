...
const data = [
  { id: 1, activity: 'Go to an art museum', price: 10, time: 'afternoon' },
  { id: 2, activity: 'Get coffee with a friend', price: 20, time: 'morning' },
  { id: 3, activity: 'See a band you\'ve never heard of in concert', price: 40, time: 'evening' },
  { id: 4, activity: 'Try a new restaurant', price: 50, time: 'noon' },
  { id: 5, activity: 'Go to an amusement park', price: 60, time: 'afternoon' },
  { id: 6, activity: 'Go fishing', price: 10, time: 'morning' },
  { id: 7, activity: 'Go to a history museum', price: 10, time: 'afternoon' },
  ...
  { id: 11, activity: 'Explore a new nearby city', price: 20, time: 'afternoon' },
  ...
  { id: 18, activity: 'Wine and cheese night with friends', price: 50, time: 'evening'},
